...
{   
    ...
    Serial.print("!!!");
    Serial.print ("STT:");
    if(control_mode==AUTO) Serial.print("1");
    else if(control_mode==MANUAL) Serial.print("0");
...
{       
        ...
        if (control_mode == AUTO) Serial3.println("Mode AUTO ***");
        else if (control_mode == RTL) Serial3.println("Mode RTL ***");
        else if (control_mode == MANUAL) Serial3.println("Mode MANUAL ***");
