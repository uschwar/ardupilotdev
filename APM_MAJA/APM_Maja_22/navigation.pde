...
void calc_altitude_error()
{
        ...
        next_WP.alt=read_alt_to_hold();   // Flight the all nav at RTL altitude (100 m)
        */
...
/*
		...
		float pitch_angle 	= dcm.pitch_sensor - AOA; // pitch_angle = pitch sensor - angle of attack of your plane at level *100 (50 = .5°)
