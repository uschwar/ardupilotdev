...
// ADS enumeration
#define ADS_PROTOCOL_NONE		0	// NO ADS protocol
#define ADS_PROTOCOL_JLN		1	// JLN Ardustation protocol
#define ADS_PROTOCOL_EMU		2	// Rembizi emulator protocol
