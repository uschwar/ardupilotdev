...
// updated code v2.0 by Jean-Louis Naudin
...
// Version 1.8.3 JLN tested in flight with Cularis and Ardupilot v 2.8 JLN on April 13, 2011 
// Version 2.0 uses DIYDrones MTK v1.6 GPS, FastSerial, and Compass libraries used for the APM v2
...
#include <AP_Common.h>	// ArduPilot Fast Serial Library
...
#define GPS_PROTOCOL 5    // 1 - NMEA,  2 - EM406,  3 - Ublox, 4 -- MediaTek  5 -- MTK16
...
//#define MAGOFFSET -28.00,115.00,-371.50  // Mag Offset for CULARIS offsets(-28.00,115.00,-371.50)
#define MAGOFFSET 45.50,-73.00,-144.50 //#define MAGOFFSET 65.50,-89.50,-1.50   // Mag Offset for ArduIMU2
...
#define DECLINATION 1.85 // Magnetic declination in (France)
...
#elif GPS_PROTOCOL == 5
AP_GPS_MTK16		GPS(&Serial);    // for the GPS Mediatek MTK firmware v1.6
#else
...
/*
    ...
    */
    ...
    compass.read();                // call the APM_Compass library routines
    if ((compass.mag_x==-32)&&(compass.mag_y==32)&&(compass.mag_z==-32)) 
    { Serial.println("");
      Serial.println("*** WARNING --- MAG INIT ERROR --- WARNING ***");
      for (;;)
