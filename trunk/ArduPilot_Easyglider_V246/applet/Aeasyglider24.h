...
/* Tested in flight on Nov 21, 2009         */
...
//1-6
#define RADIO_SWITCH_ACTION 2 // 0: TX Switch centered = waypoint mode & full = RTL mode. 1: TX Switch centered = RTL & full = waypoint mode. 2: Arduino Duemilanove
//1-7
#define GPS_PROTOCOL 3 // 0 = NMEA, 1=SIRF, 2=uBlox, 3=GPSEmulator : Choose protocol
//1-8
...
//1-11
#define INTPUT_VOLTAGE 4900.0 // voltage in millis your power regulator is feeding your ArduPilot. Measure and set this to have an accurate pressure and battery level readings. (you need a multimeter to measure this of course).
//1-12
