// AP_PID_setting FILE FOR MULTIPLEX  EASYGLIDERS by Jean-Louis Naudin
...
#define SERVO_ROLL_INT_MAX 200	                        // Maximium integrator value in degrees * 100
...
// IMPORTANT!!	Servo Gain values will be 100 times less than equivalent gains for ArduPilot 2.5
#define SERVO_RUDDER_P .08				// 	Primary value to tune - overall proportional term determines how much rudder you use to coordinate turn
...
#define NAV_ROLL_P .65	//0.07				// Primary value to tune - overall proportional term determines how aggressively we bank to change heading
#define NAV_ROLL_I .00 	//0.01				// roll PID integrator gain (value should generally be low)
#define NAV_ROLL_D .00	//0.02				// roll PID derivative gain (for advanced users - should be zero for most airframes)
#define NAV_ROLL_INT_MAX 200		                // Maximium integrator value in degrees * 100
