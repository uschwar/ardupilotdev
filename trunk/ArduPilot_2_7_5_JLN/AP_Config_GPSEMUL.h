/* ArduPilot 2.8 Config FILE FOR GPS EMULATOR and MULTIPLEX CULARIS by Jean-Louis Naudin */
// CONFIG FILE FOR GPS Emulator by Jean-Louis Naudin
...
#define POSITION_1 AUTO // the default, don't bother changing.
...
#define GCS_PROTOCOL 	6		// 0 = Standard ArduPilot (LabVIEW/HappyKillmore), 
					// 1 = special test, 
					// 2 = Ardupilot Binary(not implemented), 
					// 3 = Xplane
					// 5 = Jason's GCS, 
                                        // 6 = GCS for GPS Emulator
...
// CULARIS
#define CH1_MIN 1104 		// (Microseconds) Range of Ailerons/ Rudder
#define CH1_MAX 1798 		// (Microseconds)
#define CH2_MIN 1061 		// (Microseconds) Range of Elevator
#define CH2_MAX 2051 		// (Microseconds)
#define CH3_MIN 1111 		// (Microseconds) Range of Throttle  - 1000 to 2000 ONLY!!!
#define CH3_MAX 2044 		// (Microseconds)
#define CH4_MIN 950 		// (Microseconds) Range of Rudder
#define CH4_MAX 2044 		// (Microseconds)
