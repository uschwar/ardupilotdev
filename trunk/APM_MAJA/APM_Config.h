...
// ArduPilotMega (JLN development version tested in flight on MAJA UAV) CONFIG FILE for v2.2f
// tested in flight on MAJA UAV on May 25, 2011
//
...
// ADS_PROTOCOL_STANDARD    ArduPilotMega binary protocol for Ardustation
//
...
#define PARAM_DECLINATION       9.00 // -0.217  // Paris    
...
// light aircraft.
//
#define AIRSPEED_CRUISE     18  //12
#define GSBOOST  100            // boost the throttle if ground speed is too low in case of windy conditions // 60
//
...
//
#define THROTTLE_MIN		10   // percent
#define THROTTLE_CRUISE		55   // 45
