...
// ArduPilotMega (JLN development version tested in flight on MAJA UAV) CONFIG FILE
// tested in flight on MAJA UAV on April 30, 2011
//
...
#define THROTTLE_CRUISE		50  // 45
#define THROTTLE_MAX		90  // 75
