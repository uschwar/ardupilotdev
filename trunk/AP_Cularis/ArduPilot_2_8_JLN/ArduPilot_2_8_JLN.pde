// ARDUPILOT 2.8 which works with the GPS EMULATOR
// april 13, 2011 - updated version from r1496 by Jean-Louis Naudin
// Tested in flight on Multiplex Cularis by Jean-Louis Naudin
//
// see : http://diydrones.com/profiles/blogs/full-autonomous-cularis-uav
//
// Hardware Ardupilot (not mega) + shield v2 + ARDUIMU (firmware v 1.8.3 JLN)
/* 
...
// Updated on 10-12-10 JLN - corrected bug of the THH output which hang the GPS Emulator
// Updated on 10-12-10 JLN - increase of the nav path accuracy with the GPS Emulator, ground_speed and ground_course set to float
// Updated on 10-12-10 JLN - Full test and PID tuning with the GPS Emulator  v 1.1.45
...
//#include "AP_ConfigEasyG.h"
#include "AP_ConfigCularis.h"
#include "AP_PID_settings.h"
//#include "AP_Config_GPSEMUL.h"
//#include "AP_PID_set_GPSEMUL.h"
