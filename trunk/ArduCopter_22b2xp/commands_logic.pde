...
static bool verify_land()      // JLN update
{      int16_t delta2 = 0, lb_offset=0;
	...
	if (delta2 < 200 ) {
		...
		roll_pitch_mode = ROLL_PITCH_STABLE;
                ...
                lb = constrain(lb, 0, 200);
                landing_boost = (int)lb + lb_offset;
                icount = icount + 0.4;
                if(landing_boost >= 150) {       // JLN update for a Kisssss landing
		    land_complete = true;
                    touchdown =  false;
                    // reset old_alt
      		    old_alt = 0;
       ...
       //Serial.printf("velocity_land %d landing_boost %d delta2 %d icount %f\n", velocity_land, landing_boost,delta2, icount);
       return false;
}
/*
