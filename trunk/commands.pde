...
static void init_home()
{
	...
	takeoff_point.id 	= MAV_CMD_NAV_WAYPOINT;         // JLN update
	takeoff_point.lng 	= g_gps->longitude;		// Lon * 10**7
	takeoff_point.lat 	= g_gps->latitude;		// Lat * 10**7
	takeoff_point.alt 	= baro_alt;

        Serial.printf("Home is set: take_off_alt %ld\n", takeoff_point.alt);
