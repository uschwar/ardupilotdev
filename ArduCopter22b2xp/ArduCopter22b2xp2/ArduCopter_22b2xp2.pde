...
#define THISFIRMWARE "ArduCopter V2.2b2xp2 JLN"
/*
...
// ================================================================================================
// Jean-Louis Naudin (JLN) updates: last update 2012-01-18
	...
	switch(control_mode){
		...
		case RTL:
			...
			if((wp_distance <= g.waypoint_radius) || check_missed_wp()){
                                old_alt = 0;
                                landing_boost 	= 0;
                                // set_mode(LAND);                // JLN update     Switch to LAND directly (No timer)
