/* ArduPilot 2.7 Header file : August 24, 2010 */
// CONFIG FILE FOR MULTIPLEX EasyGlider by Jean-Louis Naudin
// Tested in flight on 08-24-10
// Updated version by JL Naudin - 08-24-10 
...
// Easyglider
#define CH1_MIN 1073 			// (Microseconds) Range of Ailerons/ Rudder
#define CH1_MAX 1869 			// (Microseconds)
#define CH2_MIN 1171 			// (Microseconds) Range of Elevator
#define CH2_MAX 1921 			// (Microseconds)
#define CH3_MIN 1103 			// (Microseconds) Range of Throttle  - 1000 to 2000 ONLY!!!
#define CH3_MAX 1896 			// (Microseconds)
#define CH4_MIN 1095 			// (Microseconds) Range of Rudder
#define CH4_MAX 1895 			// (Microseconds)

/*
// Basic
#define CH1_MIN 1000 			// (Microseconds) Range of Ailerons/ Rudder
#define CH1_MAX 2100 			// (Microseconds)
#define CH2_MIN 1000 			// (Microseconds) Range of Elevator
#define CH2_MAX 2100 			// (Microseconds)
#define CH3_MIN 1000 			// (Microseconds) Range of Throttle  - 1000 to 2000 ONLY!!!
#define CH3_MAX 2100 			// (Microseconds)
...
#define GSBOOST  50                     // boost the throttle if ground speed is too low in case of windy conditions
...
#define THROTTLE_MAX 80   	        // (0-100) example: 70 = 56% throttle (lower this if your plane is overpowered)
...
#define REMEMBER_LAST_WAYPOINT 0 	//	If set 1 = will remember the last waypoint even if you restart the autopilot.
