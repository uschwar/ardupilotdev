// AP_PID_setting FILE FOR GPS EMULATOR and MULTIPLEX CULARIS by Jean-Louis Naudin
// Tested in flight on 09-08-10

#define XTRACK_GAIN 20 					// Amount to compensate for crosstrack (degrees/100 per meter)
...
#define NAV_ROLL_P .3					// Primary value to tune - overall proportional term determines how aggressively we bank to change heading
