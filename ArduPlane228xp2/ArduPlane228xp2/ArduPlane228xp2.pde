...
#define THISFIRMWARE "ArduPlane V2.28xp2"      // Updated version for the new library (parameters)
/*
...
//
// for non explorers, uses the released version at: http://code.google.com/p/ardupilot-mega/downloads/list
//
// Jean-Louis Naudin (JLN) updates: last update 2012-02-15
//
// 2012-02-15: Added external parameters for AUTO_WP_RADIUS and CLOSED_LOOP_NAV
// 2012-02-14: Updated with the new parameters descriptors
// 2012-02-07: Tested on Xplane v9.70 with the additive-se electro-glider
// 2012-02-04: Tuning of the final slope for a smooth touchdown, tested with the Nimbus 4 on AeroSIM-RC 3.83 in HIL mode, tested with the Nimbus 4 on AeroSIM-RC 3.83 in HIL
...
// 2012-02-01: add HIL mode test for AeroSIM RC v3.83 (APMHill plugin tested with the Nimbus 4m electro-glider model) see GCS_Mavlink.pde
// 2012-02-01: the CLI switch can be disabled, this allows to use only a APM CPU board without an IMU shield for HIL test
//
...
static int AOA = 0;    // Angle Of Attack
static int climb_rate;
  ...
  */                              
				...
				if (land_complete){
					...
					g.channel_throttle.servo_out = 0;
                                        ...
                                        AOA = 50;    // hold the pitch up to slow down
                                        } 
				}
				break;
