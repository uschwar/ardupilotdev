...
// ===============
//
// _KR_v1.1a   01-10-2011 by JLN: bug of gyro direction reversing corrected
//
//
// _KR_v1.1	Audible arming sound (manuLRK's source)
//			PWM refresh rate (manuLRK's source)
